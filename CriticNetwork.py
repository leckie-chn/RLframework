...
class CriticNetwork(object):
    ...
    def create_critic_network(self):
        ...
        h4 = Dense(50, activation='sigmoid')(h3)
        h5 = Dense(50, activation='relu')(h4)
        h6 = Dense(50, activation='sigmoid')(h5)
        h7 = Dense(50, activation='relu')(h6)
        h8 = Dense(20, activation='relu')(h7)
        h9 = Dense(20, activation='relu')(h8)
        Q_value = Dense(1, activation='linear')(h9)
