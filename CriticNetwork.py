...
class CriticNetwork(object):
	...
	h4 = Dense(500, activation='relu')(h1)
	h2 = Dense(500, activation='relu')(h4)
	h3 = Dense(100, activation='sigmoid')(h2)
	h5 = Dense(100, activation='sigmoid')(h3)
	h6 = Dense(50, activation='sigmoid')(h5)
	h7 = Dense(50, activation='sigmoid')(h6)
        Q_value = Dense(1, activation='linear')(h7)
